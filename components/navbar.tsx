            ...
            <div className="flex items-center">
              <Link href="/" className="flex items-center gap-1.5 sm:gap-2 group">
                <motion.div
                  ...
                  className="relative h-9 w-[144px] sm:h-10 sm:w-[160px] md:h-11 md:w-[176px]"
                >
                  <Image
                    src="/images/logo.png"
                    alt="XingYi Trading"
              ...
              <ul className="flex items-center space-x-0.5 sm:space-x-1 lg:space-x-2">
                ...
                <DropdownNavItem
                  ...
                  items={[
                    ...
                    { href: "/products/361-series", label: "361 Series Sunflower Seeds" },
                    { href: "/products/363-series", label: "363 Series Sunflower Seeds" },
                    { href: "/products/tq6-series", label: "Tongqing No.6 (TQ6) Series" },
                  ]}
                  pathname={pathname}
                  onHover={() => setHoveredItem("products")}
                  onLeave={() => setHoveredItem(null)}
                  isHovered={hoveredItem === "products"}
                />
                ...
                <NavItem
                  ...
                  onHover={() => setHoveredItem("compare")}
                  onLeave={() => setHoveredItem(null)}
                  isHovered={hoveredItem === "compare"}
                />
...
function DropdownNavItem({
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className="absolute left-0 top-full pt-1 w-48 sm:w-56 z-50">
        <div
          className="rounded-xl bg-white dark:bg-gray-800 shadow-lg p-1.5 sm:p-2"
          role="menu"
