              ...
              <div className="flex items-center justify-between border-b py-3 sm:py-4">
                <Link href="/" className="flex items-center gap-1.5 sm:gap-2" onClick={onClose}>
                  <motion.div
                    ...
                    className="relative h-8 w-[120px] sm:h-9 sm:w-[135px]"
                  >
                    <Image
                      src="/images/logo.png"
                      alt="XingYi Trading"
                ...
                >
                  ...
                  >
                    ...
                    <MobileSubNavItem
                      ...
                      label="361 Series"
                      isActive={pathname === "/products/361-series"}
                      onClick={onClose}
                    />
                    <MobileSubNavItem
                      href="/products/363-series"
                      label="363 Series"
                      isActive={pathname === "/products/363-series"}
                      onClick={onClose}
                    />
                    <MobileSubNavItem
                      href="/products/tq6-series"
                      label="Tongqing No.6 (TQ6)"
                      isActive={pathname === "/products/tq6-series"}
                      onClick={onClose}
                    />
                  </motion.div>
                </motion.div>
